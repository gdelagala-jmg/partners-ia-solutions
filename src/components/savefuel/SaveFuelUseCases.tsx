        ...
        <section id="use-cases" className="py-10 bg-white font-outfit border-t border-gray-100">
            <div className="max-w-[1200px] mx-auto px-4 md:px-6">
                <div className="text-center mb-8 md:mb-12">
                    ...
                    <h2 className="text-[32px] md:text-[52px] font-black tracking-tighter leading-[1.1]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-[1000px] mx-auto">
                    {useCases.map((uc, idx) => (
                        <motion.div
                            ...
                            className={`group bg-gray-50/30 rounded-2xl md:rounded-[32px] border ${uc.borderColor} p-6 md:p-10 hover:bg-white hover:shadow-2xl transition-all duration-500 relative overflow-hidden`}
                        >
                            <div className="flex flex-col h-full relative z-10">
                                <div className={`w-14 h-14 md:w-16 md:h-16 rounded-[20px] ${uc.bg} flex items-center justify-center mb-6 md:mb-8 transform group-hover:scale-110 transition-transform`}>
                                    <uc.icon className={`${uc.color}`} size={28} strokeWidth={2.5} />
                                </div>
                                <h3 className="text-[22px] md:text-[28px] font-black text-[#1D1D1F] mb-4 tracking-tight">{uc.title}</h3>
                                <p className="text-[15px] md:text-[16px] text-gray-500 leading-relaxed font-inter font-medium mb-8 flex-1">{uc.desc}</p>
