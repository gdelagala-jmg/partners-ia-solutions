        ...
        <section className="py-8 lg:py-8 bg-gray-50">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="flex flex-col items-center justify-center mb-12 px-4 text-center">
                    ...
                    >
                        <Newspaper size={12} className="mr-2 text-blue-500" />
                        IA Daily Insights
                    </motion.div>
                    ...
                    <Link
                        href="/noticias"
                        className="inline-flex items-center px-6 py-2.5 bg-white text-black font-semibold rounded-xl border border-gray-200 hover:border-blue-500 hover:text-blue-600 transition-all shadow-sm hover:shadow-md group text-sm"
                    >
