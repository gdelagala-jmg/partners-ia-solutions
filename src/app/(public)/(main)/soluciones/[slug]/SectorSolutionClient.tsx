...
export default function SectorSolutionClient({ sector }: SectorSolutionClientProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Solicitud recibida. Nos pondremos en contacto contigo en menos de 24h.")
  }
    ...
    <div className="min-h-screen bg-gray-50 pb-16">
      <div className="relative pt-28 pb-16 lg:pt-28 lg:pb-24 bg-white border-b border-gray-100 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 relative z-10 text-center">
            ...
            >
                ...
                <span className="text-blue-600 break-words">{sector.name}</span>
            </motion.h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 mt-8 md:mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10 items-start">
            <div className="lg:col-span-7 bg-white p-6 md:p-12 rounded-3xl shadow-sm border border-gray-100 relative overflow-hidden">
                ...
                <div className="bg-white p-5 md:p-8 rounded-3xl shadow-xl shadow-blue-900/5 border border-gray-100">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <textarea 
                                rows={3}
                                placeholder="Me gustaría conocer más sobre las soluciones..."
